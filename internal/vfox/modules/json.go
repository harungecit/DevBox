...
// preloadJSON registers `require("json")` (encode/decode). Ported from vfox,
// itself a fork of github.com/layeh/gopher-json.
...
func jsonDecode(L *lua.LState) int {
	...
	value, err := JSONDecode(L, []byte(str))
	if err != nil {
		L.Push(lua.LNil)
...
// JSONEncode returns the JSON encoding of a Lua value.
...
// JSONDecode converts JSON data to Lua values.
